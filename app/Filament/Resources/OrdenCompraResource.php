    ...
    public static function form(Form $form): Form
    {
        ...
        this.value = v;",
                                        ...
                                        Forms\Components\Placeholder::make('subtotal_linea')
                                            ->label('Subtotal')
                                            ->content(fn() => new \Illuminate\Support\HtmlString('<span data-oc-subtotal>$ 0.0000</span>'))
                                            ->columnSpan(['default' => 12, 'lg' => 1]),
                                        ...
                                        Forms\Components\Placeholder::make('total_linea')
                                            ->label('Total Item')
                                            ->content(fn() => new \Illuminate\Support\HtmlString('<span data-oc-total>$ 0.0000</span>'))
                                            ->columnSpan(['default' => 12, 'lg' => 2]),
                                    ]),
                            ])
                            ->relationship()
