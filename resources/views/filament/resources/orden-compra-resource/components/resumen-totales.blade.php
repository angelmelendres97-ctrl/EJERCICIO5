...
<table class="w-full text-sm" data-oc-summary>
    <tbody data-oc-summary-body>
        <tr>
            <th class="text-right font-semibold pr-4">Subtotal</th>
            <td class="text-right font-bold w-32" data-oc-summary-subtotal>$ {{ number_format($subtotalGeneral, 2, '.', ',') }}</td>
        </tr>
        <tr>
            <th class="text-right font-semibold pr-4">Total Descuento</th>
            <td class="text-right font-bold w-32" data-oc-summary-descuento>$ {{ number_format($descuentoGeneral, 2, '.', ',') }}</td>
        </tr>
        ...
        <tr class="border-t border-gray-300 dark:border-gray-700">
            ...
            <td class="text-right font-extrabold text-xl text-primary-600 w-32" data-oc-summary-total>$ {{ number_format($totalGeneral, 2, '.', ',') }}</td>
        </tr>
    </tbody>
</table>
